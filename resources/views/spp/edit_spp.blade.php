<x-layout-component title="Edit SPP">
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            ...
                            @method('put')
                                <div class="form-group mb-4 row mx-auto">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" value="{{ $spp->id_spp }}" name="id_spp" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-4 row mx-auto">
                                    <label class="col-md-3 text-right">Tahun</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{ $spp->tahun }}" name="tahun" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group mb-4 row mx-auto">
                                    <label class="col-md-3 text-right">Nominal</label>
                                    <div class="col-md-6">
                                        <input type="text" value="{{ format_rupiah($spp->nominal) }}" name="nominal" class="form-control">
                                    </div>
                                </div>
